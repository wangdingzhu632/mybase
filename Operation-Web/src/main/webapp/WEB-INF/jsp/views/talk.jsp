...
<%
	...
	String from = (String)request.getSession().getAttribute("name").toString();
	String to = (String)request.getSession().getAttribute("to").toString();
...
<script>
		...
		if ('WebSocket' in window) {
			//ws://localhost:8080/agriccloud//ws?uid=1
