...
public class BaseFormAuthenticationFilter extends FormAuthenticationFilter {
	 ...
	 * @param mappedValue
	 * @return
	 * @see org.apache.shiro.web.filter.authc.AuthenticatingFilter#isAccessAllowed(ServletRequest,
...
//	}
	 ...
	 * @return
	 * @throws Exception
	 * @see FormAuthenticationFilter#onLoginSuccess(AuthenticationToken,
	 *      Subject, ServletRequest,
	 *      ServletResponse)
	 */
	@Override
